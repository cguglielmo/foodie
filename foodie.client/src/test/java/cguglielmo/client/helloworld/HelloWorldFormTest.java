package cguglielmo.client.helloworld;
...
import cguglielmo.client.helloworld.HelloWorldForm.MainBox.TopBox.MessageField;
...
public class HelloWorldFormTest {
  ...
  /**
   * Return a reference {@link HelloWorldFormData} on method {@link IHelloWorldService#load(HelloWorldFormData)}.
   */
  @Before
  public void setup() {
